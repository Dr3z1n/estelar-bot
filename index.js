...
async function startHisoka() {
    ...
    const hisoka = hisokaConnect({
        ...
        browser: ['🔥☄️𝙀𝙨𝙩⃟𝙚𝙡𝙖𝙧 𝙊𝙧𝙞⃟𝙤𝙣☄️🔥','Dr3z1n','1.0.0'],
        auth: state,
        version
    })
    ...
    hisoka.sendMessage(callerId, { text: `Sistema de bloqueio automático!\nNão chame bot!\nEntre em contato com o proprietário para ser aberto!`}, { quoted : pa7rick })
    await sleep(8000)
