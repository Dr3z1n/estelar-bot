...
const banner = cfonts.render(('ESTELAR|ORION'), {
    font: 'block',
    align: 'center',
	colors: ['red', '#BC0000'],   
    lineHeight: 1
...
module.exports = {randompalavra, getExtension, wait, simih, getBuffer, h2k, generateMessageID, getGroupAdmins, getRandom, start, info, success, banner, close }
